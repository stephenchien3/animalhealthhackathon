                    ...
                    <div className="relative py-32 md:pt-44">
                        ...
                        <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
                            <div className="mx-auto max-w-md text-center">
                                ...
                                <p className="text-black mt-4 text-balance ">CleanFeed is your all-in-one platform to build and track drying sheds for soybean-based animal feed.
